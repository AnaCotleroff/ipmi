class Zorro {
  constructor() {
    this.x = 85; // Posición inicial del Zorro en el eje X
  ...
  lanzarObstaculo() {
    ...
    if (frameCount - this.tiempoLanzar > intervaloLanzamiento) {
      let tipo = 'abajo'; // El obstáculo siempre será 'abajo' (cuchillo)
      
      // Establecer las posiciones fijas de y para los cuchillos
      let y = random([300, 400]); // El cuchillo se lanzará en y = 300 o y = 400
